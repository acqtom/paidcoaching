...
export default function TeamAccessEntryPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    router.push(`/team-access/${encodeURIComponent(normalized)}`);
  }
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-50 px-6">
      ...
      <div className="w-full max-w-sm">
        ...
        <p className="text-sm text-gray-500 mb-6 text-center">
          Ask whoever shared their Weekly Content Hub with you for their team secret key.
        </p>
